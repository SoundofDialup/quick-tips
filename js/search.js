const pages = [
  {
    title: 'Fix bluetooth connect/disconnect spam in Arch linux',
    url: '/tip/linux/bluetooth-connect-disconnect-spam/',
    keywords: [
      'bluetooth',
      'connect',
      'connection',
    ...
    description: 'Fix bluetooth connect/disconnect spam in Arch linux.',
  },
  {
  ...
  },
  {
    ...
    description: 'How to get the IP address of a Linux machine.',
  },
...
function displayResults(results) {
  ...
  if (results.length > 0) {
    ...
    resultsContainer.innerHTML = '<p class="text-slate-300">Keep typing...</p>';
  }
}
